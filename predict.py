...
def predict(run_dir, checkpoint_name, test_data_file_path, input_batch_size):
    ...
    with graph.as_default():
        ...
        num_batches = int(len(data)/input_batch_size)
        all_predictions = []
        sum_accuracy = 0
    ...
    preds_output_file_path = test_data_file_path + '.preds'
    ...
    positive_samples_file_path = preds_output_file_path + '.positive'
...
def main():
    ...
    predict(run_dir, checkpoint_name, test_data_file_path, input_batch_size)
